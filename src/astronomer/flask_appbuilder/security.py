    ...
    **Required JWT token claims**
    ...
    def before_request(self):
        ...
        if current_user.is_anonymous:
            ...
            log.error(f"current_app.login_manager._user_callback {current_app.config._user_callback}")
            log.error(f"current_app.login_manager._request_callback {current_app.config._request_callback}")
